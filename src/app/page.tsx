    ...
    <>
      ...
      <main className="flex-1 flex flex-col items-center px-4 relative">
        ...
        <section className="w-full max-w-4xl text-center pt-10 pb-12 sm:pt-16 sm:pb-16 space-y-5">
          ...
          {/* Giant Title */}
          <h1 className="text-7xl sm:text-8xl md:text-9xl font-display font-bold tracking-tight uppercase leading-[0.85] text-white">
            TEBIINDER
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/buscar"
              className="px-8 py-4 bg-[#FF5A00] text-white border-4 border-black font-display font-bold text-xl sm:text-2xl uppercase tracking-wider neo-shadow hover:scale-105 active:scale-95 transition-transform duration-100 flex items-center gap-3 rounded-xl"
            >
            ...
            {!user && (
              <a
                href="/auth/login"
                className="px-6 py-4 bg-[#5865F2] text-white border-4 border-black font-display font-bold text-xl sm:text-2xl uppercase tracking-wider neo-shadow hover:scale-105 active:scale-95 transition-transform duration-100 flex items-center gap-3 rounded-xl"
              >
