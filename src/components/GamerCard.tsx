      ...
      >
        ...
        <div className="flex flex-col gap-3 mt-6 pt-5 border-t-2 border-white/10">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            {/* R6 Tracker Profile Link */}
            {jugador.ubisoft_id && (
              <a
                href={`https://r6.tracker.network/r6siege/profile/${jugador.plataforma === "pc" ? "uplay" : jugador.plataforma === "playstation" ? "psn" : "xbl"}/${encodeURIComponent(jugador.ubisoft_id)}/overview`}
                target="_blank"
